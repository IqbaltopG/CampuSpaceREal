...
public class ReserveRoomPanel extends JPanel {
    ...
    public ReserveRoomPanel(int userId, String role, DefaultListModel<String> notificationList, Runnable onSuccess,
        ...
        tableModel = new DefaultTableModel(
                new String[]{"ID", "Gedung", "Ruangan", "Tanggal", "Sesi", "Keperluan"}, 0);
    ...
    private void loadRooms() {
        ...
        if (buildingBox.getSelectedItem() == null) return;
    ...
    private String getSesiFromStartTime(Timestamp startTime) {
        ...
        switch (jam) {
            case "08:00:00": return "Sesi 1";
            case "10:00:00": return "Sesi 2";
            case "13:00:00": return "Sesi 3";
            case "15:00:00": return "Sesi 4";
            default: return jam;
        }
    }
    ...
    private Timestamp getStartTime() {
        ...
        String jamMulai;
        switch (session) {
            case "Sesi 1": jamMulai = "08:00:00"; break;
            case "Sesi 2": jamMulai = "10:00:00"; break;
            case "Sesi 3": jamMulai = "13:00:00"; break;
            case "Sesi 4": jamMulai = "15:00:00"; break;
            default: jamMulai = "08:00:00";
        }
    ...
    private Timestamp getStopTime() {
        ...
        String jamSelesai;
        switch (session) {
            case "Sesi 1": jamSelesai = "10:00:00"; break;
            case "Sesi 2": jamSelesai = "12:00:00"; break;
            case "Sesi 3": jamSelesai = "15:00:00"; break;
            case "Sesi 4": jamSelesai = "17:00:00"; break;
            default: jamSelesai = "10:00:00";
        }
    ...
    private String findComboItem(JComboBox<String> box, String name) {
        for (int i = 0; i < box.getItemCount(); i++) {
            ...
            if (item.contains(name)) return item;
        }
        return null;
    }
